...
export default function ReportsPanel({ accent, showsCycle = true }) {
  ...
  return (
    <>
      ...
      {/* Main card — this is what prints */}
      <Card style={{ marginTop: 18 }} className="fb-reports-panel">
        ...
        {/* Period type tabs */}
        <div className="fb-print-hide" style={{ display: "flex", gap: 6, marginBottom: 12, padding: 4, background: "rgba(44,35,32,.04)", borderRadius: 11, overflowX: "auto" }}>
        ...
        {/* Period navigator */}
        <div className="fb-print-hide" style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
...
/* ============================================================
   Print styles
   - .fb-print-only  → hidden on screen, visible in print
   - .fb-print-hide  → visible on screen, hidden in print
   - .fb-reports-panel → the card that contains all report content
   ============================================================ */
  ...
  return (
    <style>{`
      ...
      @media print {
        ...
        /* Show only the report panel and its children */
        .fb-reports-panel,
        .fb-reports-panel *,
        .fb-print-only,
        .fb-print-only * {
        ...
        /* Position the report panel to fill the page */
        .fb-reports-panel {
